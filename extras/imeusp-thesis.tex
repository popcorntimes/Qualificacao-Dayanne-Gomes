...
\providecommand\contributorname{} % Contributor / Colaborador(a)
...
\expandafter\addto\csname captions\@IMEpt\endcsname{%
  ...
  \renewcommand\contributorname{%
  \iftoggle{@tcc}{%
    \ifdefstring{\@contributorGender}{masc}
      {Supervisor}
      {Supervisora}%
  }{%
    \ifdefstring{\@contributorGender}{masc}
...
\NewDocumentCommand{\colaborador}{O{masc} m}{
  \gdef\@contributor{#2}
  \gdef\@contributorGender{#1}
}
